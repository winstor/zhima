    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2 col-xs-2"><a style="text-decoration:none" href="{{route('members.patents.index',[],false)}}" class="d-sour" target="_blank">专利总览</a></div>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3"><a style="text-decoration:none" href="{{route('members.notices.index',[],false)}}" class="d-sour" target="_blank">通知书总览</a></div>
            </div>
...
<script>
    $("#d-zhuanlis").on("click",function()
    {
        ...
        var url = "{{route('members.patents.index',[],false)}}";
        window.open(url + "?keyword=" + encodeURI(keyword) + "");
    })
    $("#d-tongzhis").on("click",function()
    {
        var keyword = $("#d-tongzhi").val();
        window.open("{{route('members.notices.index',[],false)}}?&keyword=" + encodeURI(keyword) + "");
    })
</script>
