    ...
    <div class="box-body">
        <div class="tab-pane active" id="tab_5_1">
            <ul class="qxjk-ul">
                ...
                <li>
                    <a class="@if(isset($filter['patent_case_id']) && isset($filter['defaultCode']) && $filter['patent_case_id'] == $key && $filter['defaultCode'] == 'top') hover @endif"  href="{{route('members.patents.index',['patent_case_id'=>$key,'defaultCode'=>'top'],false)}}">
...
<div class="box box-warning box-solid">
    <div class="box-body">
        <div class="col-md-12">
            <form action="{{route('members.patents.index')}}" method="get">
