    ...
    <div class="container">
        ...
        <div class="product">
            ...
            <div class="pro_item">
                ...
                <ul>
                    <li class="i1">{{$list['id']}}</li>
                    <li class="i2">
                        <a href="/supply-319.html"><em class="e{{$list['patent_type_id']}}">{{$list->type->name??''}}</em>{{$list['patent_sn']}}</a></li>
                    <li class="i3">
                        <a href="/supply-319.html">{{$list['patent_name']}}</a></li>
                    <li class="i4">已下证</li>
